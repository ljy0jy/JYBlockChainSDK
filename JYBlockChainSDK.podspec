...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ljygithub@protonmail.com/JYBlockChainSDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ljygithub@protonmail.com' => 'ljygithub@protonmail.com' }
  s.source           = { :git => 'https://github.com/ljygithub@protonmail.com/JYBlockChainSDK.git', :tag => s.version.to_s }
